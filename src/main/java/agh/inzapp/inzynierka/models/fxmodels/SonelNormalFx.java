...
public class SonelNormalFx extends DataFx{
	...
	private void initOwnRecords() {
		...
		records.put(UniNames.U0_avg_total,null);
		records.put(UniNames.U0_max_total,null);
		records.put(UniNames.U0_min_total,null);
		records.put(UniNames.U1_avg_total,null);
		records.put(UniNames.U1_max_total,null);
		records.put(UniNames.U1_min_total,null);
		records.put(UniNames.U2_avg_total,null);
		records.put(UniNames.U2_max_total,null);
		records.put(UniNames.U2_min_total,null);
		records.put(UniNames.I0_avg_total,null);
		records.put(UniNames.I0_max_total,null);
		records.put(UniNames.I0_min_total,null);
		records.put(UniNames.I1_avg_total,null);
